...
import 'package:hotshi/Screen/pays/residence.dart';
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if(selectedValue!['id']!=""){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const ResidenceScreen()),
                      );
                      GlobalVariable.origine = selectedValue!['id'];
                    }else{
                      showDialog(
                        context: context,
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: const Text("Choisir un pays d'origine et recommencé" ),
                            actions: [
                              ElevatedButton(
